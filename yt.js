// =================================================================
// 0. VARIABEL GLOBAL (UNTUK ANTREAN AUTOMATION NEXT / LOOP)
// =================================================================
...
async function searchSongs() {
    ...
    try {
        ...
        // 🔥 KUNCI UTAMA: Rekam hasil pencarian ke antrean agar fungsi autoplay mengenali lagu berikutnya
        currentTracksList = data.results; 

        data.results.forEach((song, i) => {
            const songRow = document.createElement("div");
            songRow.className = "song-row"; // Menambahkan class untuk animasi CSS klik
            ...
            songRow.addEventListener("click", () => {
                currentTrackIndex = i; // Catat indeks antrean lagu yang sedang aktif
...
async function playAudioTrack(videoId, title, thumbnail) {
    ...
    try {
        ...
        // Memaksa browser meminta data stream parsial agar bisa langsung lompat ke menit tengah manapun
        audioPlayer.load(); 
...
// =================================================================
// 3. AUTOMATION & ENDED EVENT LISTENER (LOOP/NEXT TRACK)
// =================================================================
const audioPlayerElement = document.getElementById("audio-player");
if (audioPlayerElement) {
    audioPlayerElement.addEventListener("ended", async () => {
        if (isLoopSingle) {
            // JIKA MODE LOOP SINGLE: Putar kembali dari detik 0
            audioPlayerElement.currentTime = 0;
            await audioPlayerElement.play();
        } else {
            // JIKA MODE NEXT: Putar lagu berikutnya secara otomatis dari antrean
...
// =================================================================
// 4. KONTROL AKHIR & SHORTCUT KEYBOARD (FIXED & UNCOMMENTED)
// =================================================================
...
// Shortcut keyboard untuk menekan Enter pada input teks pencarian

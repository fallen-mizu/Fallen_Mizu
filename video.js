// =================================================================
// MIZU MULTIMEDIA ENGINE - STANDARD NATIVE EMBED v12 (video.js)
// =================================================================

/**
 * Memutar trek video menggunakan Native Iframe Resmi tanpa pemotongan (No Clipping)
 * Tombol Close dipindahkan ke luar area video agar layout lebih bersih.
...
async function playVideoTrack(videoId, title) {
    ...
    // Render Player: Tanpa trik negatif-margin/clipping. Video utuh 100%.
    // Tombol close ditempatkan di struktur kontainer luar (di atas baris judul).
